...
I=imread('MatriceBeta.bmp');%Uso la funzione lettura
% J=rumore(I, 0.2, 0.2);
% figure; imshow(J); title('Input con rumore');
Negativo_RGB = imcomplement(I);
...
[B,L,n,A] = bwboundaries(image_cropped2); %trovo tutti gli oggetti nell'immagine 
...
BIT=codifica(image_cropped2, centri); %codifica l'immagine in bit
BIT