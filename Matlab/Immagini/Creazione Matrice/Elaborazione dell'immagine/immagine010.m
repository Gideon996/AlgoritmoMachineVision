...
image_cropped = ritaglio2(bw, tolleranza); %ritaglia l'immagine 
% image_cropped2 = rotazione(rotate, image_cropped, 2); %ruota l'immagine di tipo 2
figure; imshow(image_cropped); title('Matrice dove lavorare');

[B,L,n,A] = oggetti(image_cropped); %trovo tutti gli oggetti nell'immagine 
...
% [rg, cl, nr, nc]=trova_cerchi2(image_cropped2); %calcolo il numero di righe, numero colonne e le loro coordinate
BIT=codifica(image_cropped, centri); %codifica l'immagine in bit
BIT